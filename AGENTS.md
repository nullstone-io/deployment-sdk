...
```
GOFLAGS=-mod=mod go get github.com/nullstone-io/deployment-sdk@<full sha of origin/master>
go mod tidy
go mod vendor
```

Consumers: `nullstone` (CLI), `enigma`, `devtools`.
